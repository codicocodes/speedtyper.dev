...
const LoginModal = () => {
  ...
  const { serverUrl, siteRoot } = getConfig()
  ...
  return (
    <>
      <button
        ...
        className="hidden sm:flex hover:bg-gray-100 bg-off-white shadow rounded items-center px-2 lg:px-4 py-1 mx-2 lg:mx-2 text-base border-gray-200 border text-gray-900"
      >
