const codeSnippet = `const IsSomeRendererActing = {
...
const ReactElementValidatorSnippet = `/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
...
// const testyCode = `code

//   more code
//   what`;

const createFactoryWithValidation = `export function createFactoryWithValidation(type) {
  return validatedFactory;
}`;
console.log(
  ReactForwardRef,
  ReactElementValidatorSnippet,
  createFactoryWithValidation,
  codeSnippet
);
export default {
  name: "ReactForwardRef",
  project: "React",
  ...
  source:
    "https://raw.githubusercontent.com/facebook/react/master/packages/react/src/ReactForwardRef.js",
  fullCodeString: codeSnippet,
};
